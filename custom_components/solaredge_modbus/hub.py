...
#        _LOGGER.debug("=============")
        ...
        self.decoded_model = OrderedDict(
            [
                ...
                ("dc_output_power", self.getValueRegister(3006, signed=False)),
                ("generated_lifetimeproduction", self.getValueLong(3008, signed=False)),
                ("ac_energy_wh",  self.getValueRegister(3009, signed=False)),
                ("generated_monthenergy",  self.getValueRegister(3011, signed=False)),
                ("generated_yearenergy",  self.getValueRegister(3017,signed=False)),
                ("generated_lastyear",  self.getValueRegister(3019, signed=False)),

                ("ac_month",  self.getValueRegister(3010, signed=False)),
                ("ac_lastmonth",  self.getValueRegister(3012, signed=False)),
                ("generated_today", self.getValueRegister(3014, numberOfDecimals=5,
                                              signed=False)),
                ("generated_yesterday", self.getValueRegister(3015, numberOfDecimals=1,
                                                    signed=False)),
