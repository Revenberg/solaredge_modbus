...
#        _LOGGER.debug("=============")
        ...
        self.decoded_model = OrderedDict(
            [
                ...
                ("ac_generated_lifetimeproduction", self.getValueLong(3008, signed=False)),
                ("ac_energy_wh",  self.getValueRegister(3009, signed=False)),
                ("ac_generated_monthenergy",  self.getValueRegister(3011, signed=False)),
                ("ac_generated_yearenergy",  self.getValueRegister(3017,signed=False)),
                ("ac_generated_lastyear",  self.getValueRegister(3019, signed=False)),
                ...
                ("ac_generated_today", self.getValueRegister(3014, numberOfDecimals=5,
                                              signed=False)),
                ("ac_generated_yesterday", self.getValueRegister(3015, numberOfDecimals=1,
                                                    signed=False)),
